...
class Todos {
    ...
    constructor(url) {
        ...
        // insertTask function
        this.addTask = (newTaskName) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                fetch(__classPrivateFieldGet(this, _Todos_backendUrl, "f") + '/new', {
                    ...
                    .then(response => response.json())
                    .then((response) => {
                    resolve(__classPrivateFieldGet(this, _Todos_instances, "m", _Todos_addToArray).call(this, response.id, newTaskName));
                }), (error) => {
                    reject(error);
                };
            }));
        ...
        this.removeTask = (id) => {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                fetch(__classPrivateFieldGet(this, _Todos_backendUrl, "f") + '/delete/' + id, {
                    method: 'delete'
                })
                    .then(response => response.json())
                    .then((response) => {
...
_Todos_backendUrl = new WeakMap(), _Todos_instances = new WeakSet(), _Todos_readJSON = function _Todos_readJSON(tasksAsJSON) {
    tasksAsJSON.forEach((taskAsJSON) => {
